    ...
    <div className="bg-white  p-3 flex flex-col gap-5  rounded-lg max-w-md shadow-lg">
        <div className="flex items-top gap-3">
            <div className=" ">
                ...
                src="https://rekhta.pc.cdn.bitgravity.com/Images/Shayar/shahryar.png" alt="" />
            </div>
            <div className="flex flex-col gap-2">
              <div>  <h2 className=" text-xl font-bold">Labour Name</h2>

                <p className="text-sm italic ">Exp: 5 years</p> </div>
                <p className=" shadow-inner  border-violet-500 border-[2px] rounded-md text-sm font-bold text-violet-400 px-1 ">Labour Description</p>
        </div>
        </div>
        <div>
